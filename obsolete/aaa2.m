function aaa2(data,kmax)
% this is the same as aaa, except that we don't orthogonalize
%  the vectors v spanning the Krylov subspace.
...
V = zeros(n,kmax);  % this may be too much.
H = zeros(kmax,kmax);
